...
class KonfigurasiController extends Controller
{
    ...
    public function storesetjamkerja(Request $request)
    {
        ...
        try {
            ...
            return Redirect('/pegawai')->with(['success' => 'Jam Kerja Berhasil Diatur']);
        } catch (\Exception $e) {
            return Redirect('/pegawai')->with(['Warning' => 'Jam Kerja Gagal Diatur']);
        }
    }
    ...
    public function updatesetjamkerja(Request $request)
    {
        ...
        try {
            ...
            Setjamkerja::insert($data);
            DB::commit();
            return Redirect('/pegawai')->with(['success' => 'Jam Kerja Berhasil Diupdate']);
        } catch (\Exception $e) {
            DB::rollBack();
            return Redirect('/pegawai')->with(['warning' => 'Jam Kerja Gagal Diupdate']);
        }
    }
}
