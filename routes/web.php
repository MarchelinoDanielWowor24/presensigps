...
Route::middleware(['auth:user'])->group(function () {
    ...
    //Unit kerja
    Route::get('/unitkerja', [Unit_KerjaController::class, 'index']);
    Route::post('/unitkerja/store', [Unit_KerjaController::class, 'store']);
    Route::post('/unitkerja/edit', [Unit_KerjaController::class, 'edit']);
    Route::post('/unitkerja/{kode_unker}/update', [Unit_KerjaController::class, 'update']);
    Route::post('/unitkerja/{kode_unker}/delete', [Unit_KerjaController::class, 'delete']);
