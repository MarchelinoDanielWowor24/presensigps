        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['pegawai', 'unitkerja']) ? 'show' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->is(['pegawai', 'unitkerja']) ? 'true' : '' }}">
                        <span
                    ...
                    <div class="dropdown-menu {{ request()->is(['pegawai', 'unitkerja']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                <a class="dropdown-item " href="/pegawai">
                                    Pegawai
                                </a>
                                <a class="dropdown-item" href="/unitkerja">
                                    Unit Kerja
                                </a>
                            </div>
                        </div>
