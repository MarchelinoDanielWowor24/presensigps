<form action="/unitkerja/{{ $unitkerja->kode_unker }}/update" method="POST" id="frmUnitKerja">
    @csrf
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $unitkerja->kode_unker }}" id=""
                    class="form-control"name="kode_unker" placeholder="Kode Unker" readonly>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $unitkerja->nama_unker }}" id="nama_unker" class="form-control"
